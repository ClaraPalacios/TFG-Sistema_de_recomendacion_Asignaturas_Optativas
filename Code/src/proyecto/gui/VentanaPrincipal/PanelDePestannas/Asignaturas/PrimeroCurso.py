...
class PrimeroCurso(QtWidgets.QFrame):
    ...
    def semestres_primero(self):
        """
        Método que inserta en la primera ventana las asignaturas del primer curso
        estableciendo su fuente y color, , así como el máximo y mínimo del slider.
        """
        ...
        self.check_box_p_p_asig1 = QtWidgets.QCheckBox(self.dicc.omitir, self)
        ...
        self.check_box_p_p_asig2 = QtWidgets.QCheckBox(self.dicc.omitir, self)
        ...
        self.check_box_p_p_asig3 = QtWidgets.QCheckBox(self.dicc.omitir, self)
        ...
        self.check_box_p_p_asig4 = QtWidgets.QCheckBox(self.dicc.omitir, self)
        ...
        self.check_box_p_p_asig5 = QtWidgets.QCheckBox(self.dicc.omitir, self)
        ...
        self.check_box_p_s_asig1 = QtWidgets.QCheckBox(self.dicc.omitir, self)
        ...
        self.check_box_p_s_asig2 = QtWidgets.QCheckBox(self.dicc.omitir, self)
        ...
        self.check_box_p_s_asig3 = QtWidgets.QCheckBox(self.dicc.omitir, self)
        ...
        self.check_box_p_s_asig4 = QtWidgets.QCheckBox(self.dicc.omitir, self)
        ...
        self.check_box_p_s_asig5 = QtWidgets.QCheckBox(self.dicc.omitir, self)
...
#         self.primero_semestres_layout.addSpacing(50)
        ...
        self.primero_semestres_groupBox.setTitle(self.dicc.op_valoraciones) 
    ...
    def values_primer_sem(self):
        """
        Método que almacena en el valor las asignaturas almacenadas en el 
        slider, en caso de estar "omitidas" almacena un cero. 
        """
        valasig1= self.slider_p_p_asig1.value() if self.label_valuep_p_asig1.text() != self.dicc.no  else 0
        valasig2= self.slider_p_p_asig2.value() if self.label_valuep_p_asig2.text() != self.dicc.no  else 0
        valasig3= self.slider_p_p_asig3.value() if self.label_valuep_p_asig3.text() != self.dicc.no  else 0
        valasig4= self.slider_p_p_asig4.value() if self.label_valuep_p_asig4.text() != self.dicc.no  else 0
        valasig5= self.slider_p_p_asig5.value() if self.label_valuep_p_asig5.text() != self.dicc.no  else 0
        valoraciones={
    ...
    def set_values_primer_sem(self,diccionario):
            ...
            if diccionario[self.labelp_p_asig2.text()]==0:
                ...
                self.label_valuep_p_asig2.setText(self.dicc.no)
            ...
            if diccionario[self.labelp_p_asig3.text()]==0:
                ...
                self.label_valuep_p_asig3.setText(self.dicc.no)
            ...
            if diccionario[self.labelp_p_asig4.text()]==0:
                ...
                self.label_valuep_p_asig4.setText(self.dicc.no)
            ...
            if diccionario[self.labelp_p_asig5.text()]==0:
                ...
                self.label_valuep_p_asig5.setText(self.dicc.no)
    ...
    def values_segundo_sem(self):
        """
        Método que almacena las asignaturas del slider del segundo semestre. 
        en caso de estar Omitidas, se almacena un 0
        """
        valasig1= self.slider_p_s_asig1.value() if self.label_valuep_s_asig1.text() != self.dicc.no  else 0
        valasig2= self.slider_p_s_asig2.value() if self.label_valuep_s_asig2.text() != self.dicc.no  else 0
        valasig3= self.slider_p_s_asig3.value() if self.label_valuep_s_asig3.text() != self.dicc.no  else 0
        valasig4= self.slider_p_s_asig4.value() if self.label_valuep_s_asig4.text() != self.dicc.no  else 0
        valasig5= self.slider_p_s_asig5.value() if self.label_valuep_s_asig5.text() != self.dicc.no  else 0
    ...
    def set_values_segundo_sem(self,diccionario):
            ...
            if diccionario[self.label_s_asig2.text()]==0:
                ...
                self.label_valuep_s_asig2.setText(self.dicc.no)
            ...
            if diccionario[self.label_s_asig3.text()]==0:
                ...
                self.label_valuep_s_asig3.setText(self.dicc.no)
            ...
            if diccionario[self.label_s_asig4.text()]==0:
                ...
                self.label_valuep_s_asig4.setText(self.dicc.no)
            ...
            if diccionario[self.label_s_asig5.text()]==0:
                ...
                self.label_valuep_s_asig5.setText(self.dicc.no)
    ...
    def valuechange_slider(self):
        """
        Metodo que modifica los valores de las asignaturas con el valor del slider. 
        En caso de estar omitidas, no lo actualiza. 
        """
