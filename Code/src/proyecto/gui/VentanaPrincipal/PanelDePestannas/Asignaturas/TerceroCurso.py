...
#         self.tercero_semestres_layout.addSpacing(50)
    ...
    def values_primer_sem(self):
        valoraciones={
            self.label_t_p_asig1.text():self.slider_t_p_asig1.value(),
            self.label_t_p_asig2.text():self.slider_t_p_asig2.value(),
            self.label_t_p_asig3.text():self.slider_t_p_asig3.value(),
            self.label_t_p_asig4.text():self.slider_t_p_asig4.value(),
            self.label_t_p_asig5.text():self.slider_t_p_asig5.value()            
            }
        return valoraciones
    ...
    def values_segundo_sem(self):
        valoraciones={
            self.label_t_asig1.text():self.slider_t_s_asig1.value(),
            self.label_t_asig2.text():self.slider_t_s_asig2.value(),
            self.label_t_asig3.text():self.slider_t_s_asig3.value(),
            self.label_t_asig4.text():self.slider_t_s_asig4.value(),
            self.label_t_asig5.text():self.slider_t_s_asig5.value()       
        }
        return valoraciones 
