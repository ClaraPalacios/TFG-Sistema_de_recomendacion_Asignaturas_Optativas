...
\begin{abstract}
Escribir el resúmen del proyecto. 
\end{abstract}

\renewcommand*\abstractname{Descriptores}
\begin{abstract}
Python, Recomendación, Predicción, Formalización, Filtro Colaborativo (FC), usuarios, items.
\end{abstract}
...
Python, Recomendación, Predicción, Formalización, Filtro Colaborativo (FC) .\end{abstract}
